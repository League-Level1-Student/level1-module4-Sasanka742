...
//complete
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==firstButton) {
			askQuestion("When was the automobile invented?","1885",200);
		}else if(e.getSource()==secondButton) {
			askQuestion("When was the Microwave invented?","1946",400);
		}else if(e.getSource()==thirdButton) {
			askQuestion("When was JAVA created?","1996",600);
		}else if(e.getSource()==fourthButton) {
			askQuestion("Who is the founer of JAVA?","James Gosling",800);
		}else if(e.getSource()==fifthButton) {
			askQuestion("What was the first web browser","WorldWideWeb",1000);
		}	
